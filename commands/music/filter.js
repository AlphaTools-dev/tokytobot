...
module.exports = {
    ...
    execute(client, message, args) {
        ...
        if (filtersUpdated[filterToUpdate]) message.channel.send(new MessageEmbed()
        .setAuthor("Un filtre a été ajouté !", "https://downloadwap.com/thumbs3/screensavers/d/new/logo-brands/equalizer_animated-83679.gif")
        ...
        .setAuthor("Un filtre a été enlevé !", "https://downloadwap.com/thumbs3/screensavers/d/new/logo-brands/equalizer_animated-83679.gif")
        .setTitle('R8 Music・:dna:')
        .setColor('RED')
